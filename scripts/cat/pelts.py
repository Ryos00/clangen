...
class Pelt():
    ...
    pelt_colours = [
        'CARAMEL', 'PALEBLUE', 'DARKCARAMEL', 'BLUE', 'WARMBLUE', 'BLACK', 'DARKBLACK',
        'CREAM', 'DARKCREAM', 'MIDGINGER', 'GINGER', 'DARKGINGER', 'RED', 'APRICOT',
        'DARKTAUPE', 'LILAC', 'DARKLILAC', 'CHOCOLATE', 'DARKCHOCOLATE', 'TAUPE',
        'FAWN', 'DARKFAWN', 'CINNAMON', 'DARKCINNAMON', 'DARKTAN', 'TAN'
    ]
    ...
    high_white = ['ANY', 'ANYTWO', 'BROKEN', 'FRECKLES', 'RINGTAIL', 'HALFFACE', 'PANTSTWO',
                ...
                'CURVED', 'GLASS', 'MASKMANTLE', 'MAO', 'PAINTED', 'SHIBAINU', 'OWL', 'BUB']
